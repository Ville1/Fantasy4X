...
public class HexPrototypes {
    ...
    private HexPrototypes()
    {
        ...
        combat_map_hex_prototypes.Add("scrubs", new CombatMapHex("Scrubs", "combat_bushes_1", new Dictionary<string, int>() { { "combat_bushes_2", 50 } }, 1.0f, 1.0f, 0, 0, 0.0f, new List<CombatMapHex.Tag>() { CombatMapHex.Tag.Open, CombatMapHex.Tag.Vegetation }));
        combat_map_hex_prototypes.Add("trees", new CombatMapHex("Trees", "combat_trees_2", new Dictionary<string, int>() { { "combat_trees_1", 40 } }, 2.0f, 2.0f, 0, 1, 0.50f, new List<CombatMapHex.Tag>() { CombatMapHex.Tag.Forest, CombatMapHex.Tag.Vegetation }));
        combat_map_hex_prototypes.Add("enchanted trees", new CombatMapHex("Enchanted Trees", "combat_enchanted_forest", new Dictionary<string, int>() { { "combat_enchanted_forest_2", 50 } }, 2.0f, 2.0f, 0, 1, 0.50f, new List<CombatMapHex.Tag>() { CombatMapHex.Tag.Forest, CombatMapHex.Tag.Vegetation }));
